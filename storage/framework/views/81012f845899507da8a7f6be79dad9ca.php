...
<div class="modal fade" id="editPotonganModal" tabindex="-1" aria-hidden="true" data-bs-backdrop="static">
    <div class="modal-dialog modal-xl modal-dialog-centered">
        <div class="modal-content">
            ...
            <form action="<?php echo e(route('jabatan.update-potongan', $jabatan->id)); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
</div><?php /**PATH C:\laragon\www\dashboard-fingerprint\resources\views/admin/jabatan/modals/edit-potongan.blade.php ENDPATH**/ ?>