                                    ...
                                    <div class="d-flex align-items-center row">
                                        <div class="col-sm-7">
                                            <div class="card-body">
                                                ...
                                                <p class="mb-4">
                                                    Ini Adalah Halaman Utama <span class="fw-bold">AFMS.</span>
                                                    <br>
                                        ...
                                        <div class="row pt-2">
                                            <div class="col">
                                                <h3 class="card-title text-nowrap">
                                                    <?php echo e($totalPegawai); ?>

                                                </h3>
                                            </div>
                                        </div>
                                        <div class="mt-3">
                                            <a href="<?php echo e(route('pegawai.index')); ?>" class="btn btn-primary btn-sm">
                                                Lihat
                                            </a>
                                        </div>
                                    </div>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <h3 class="card-title text-nowrap mb-1 mt-3">
                                            <?php echo e($terlambatHariIni); ?> Orang
                                        </h3>
                                    </div>
                                </div>
                            </div>
...
<?php /**PATH C:\laragon\www\dashboard-fingerprint\resources\views/layouts/admin/templateHome.blade.php ENDPATH**/ ?>