...
<div class="modal fade" id="editDendaLiburModal" tabindex="-1" aria-hidden="true" data-bs-backdrop="static">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form action="<?php echo e(route('jabatan.update-denda-libur', $jabatan->id)); ?>" method="POST">
                <?php echo csrf_field(); ?>
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" name="denda_per_hari_libur" 
                               value="<?php echo e($jabatan->denda_per_hari_libur ?? 50000); ?>" min="0" required>
                    ...
                    <div class="alert alert-warning border-0">
                        ...
                        <div class="mt-2">
                            ...
                            <p class="mb-0"><strong>Total denda: 2 × Rp <?php echo e(number_format($jabatan->denda_per_hari_libur ?? 50000, 0, ',', '.')); ?> = Rp <?php echo e(number_format(2 * ($jabatan->denda_per_hari_libur ?? 50000), 0, ',', '.')); ?></strong></p>
                        </div>
                    </div>
                </div>
...
</div><?php /**PATH C:\laragon\www\dashboard-fingerprint\resources\views/admin/jabatan/modals/edit-denda-libur.blade.php ENDPATH**/ ?>