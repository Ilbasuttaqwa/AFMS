<?php $__env->startSection('title', 'Manajemen Fingerprint X100-C'); ?>
...
<div class="container-fluid">
    ...
    <div class="alert alert-info alert-dismissible fade show" role="alert">
        ...
        <strong><?php echo e(auth()->user()->role === 'manager' ? 'Manager' : 'Admin'); ?>:</strong>
        <?php if(auth()->user()->role === 'manager'): ?>
            Anda dapat melihat dan mengelola semua data absensi dari seluruh cabang.
        <?php else: ?>
            Anda hanya dapat melihat data absensi dari cabang: <strong><?php echo e(auth()->user()->cabang->nama_cabang ?? 'Tidak ada cabang'); ?></strong>
        <?php endif; ?>
                    ...
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800" id="totalActiveBranches">
                                <?php echo e($cabangs->where('fingerprint_active', true)->count()); ?>
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    ...
                    <div class="dropdown no-arrow">
                        ...
                        <div class="dropdown-menu dropdown-menu-right shadow animated--fade-in">
                            <a class="dropdown-item" href="#" onclick="testConnection(<?php echo e($cabang->id); ?>)">
                                <i class="fas fa-plug fa-sm fa-fw mr-2 text-gray-400"></i>
                                Test Koneksi
                            </a>
                            <a class="dropdown-item" href="#" onclick="syncBranch(<?php echo e($cabang->id); ?>)">
                ...
                <div class="card-body">
                    ...
                    <div class="row mb-3">
                        <div class="col-sm-6">
                            ...
                            <?php if($cabang->fingerprint_active): ?>
                        ...
                        <div class="col-sm-6">
                            ...
                            <code><?php echo e($cabang->fingerprint_ip ?? 'Belum dikonfigurasi'); ?></code>
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-sm-6">
                            ...
                            <code><?php echo e($cabang->fingerprint_port ?? '4370'); ?></code>
                        </div>
                        <div class="col-sm-6">
                            <small class="text-muted">Last Sync:</small><br>
                            <span class="text-info">
                                <?php echo e($cabang->last_sync ? \Carbon\Carbon::parse($cabang->last_sync)->diffForHumans() : 'Belum pernah'); ?>
                    ...
                    <div class="config-form">
                        <form id="configForm<?php echo e($cabang->id); ?>" onsubmit="updateConfig(event, <?php echo e($cabang->id); ?>)">
                            <?php echo csrf_field(); ?>
                            <?php echo method_field('PUT'); ?>
                            
                            <div class="form-row">
                                <div class="form-group col-md-8">
                                    <label for="fingerprint_ip<?php echo e($cabang->id); ?>">IP Address</label>
                                    <input type="text" class="form-control" 
                                           id="fingerprint_ip<?php echo e($cabang->id); ?>" 
                                           name="fingerprint_ip" 
                                           value="<?php echo e($cabang->fingerprint_ip); ?>"
                                           placeholder="192.168.1.100" required>
                                </div>
                                <div class="form-group col-md-4">
                                    <label for="fingerprint_port<?php echo e($cabang->id); ?>">Port</label>
                                    <input type="number" class="form-control" 
                                           id="fingerprint_port<?php echo e($cabang->id); ?>" 
                                           name="fingerprint_port" 
                                           value="<?php echo e($cabang->fingerprint_port ?? 4370); ?>"
                            ...
                            <div class="form-group">
                                <div class="custom-control custom-switch">
                                    <input type="checkbox" class="custom-control-input" 
                                           id="fingerprint_active<?php echo e($cabang->id); ?>" 
                                           name="fingerprint_active"
                                           <?php echo e($cabang->fingerprint_active ? 'checked' : ''); ?>>
                                    <label class="custom-control-label" for="fingerprint_active<?php echo e($cabang->id); ?>">
                            ...
                            <div class="form-group mb-0">
                                ...
                                <button type="button" class="btn btn-info btn-sm mr-2" 
                                        onclick="testConnection(<?php echo e($cabang->id); ?>)">
                                    <i class="fas fa-plug mr-1"></i>
                                    Test Koneksi
                                </button>
                                <button type="button" class="btn btn-success btn-sm sync-button" 
                                        onclick="syncBranch(<?php echo e($cabang->id); ?>)">
...
<?php echo $__env->make('layouts.admin.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\dashboard-fingerprint\resources\views/admin/fingerprint/index.blade.php ENDPATH**/ ?>