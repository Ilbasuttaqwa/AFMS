...
<div class="modal fade" id="editBonusModal" tabindex="-1" aria-hidden="true" data-bs-backdrop="static">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form action="<?php echo e(route('jabatan.update-bonus', $jabatan->id)); ?>" method="POST">
                <?php echo csrf_field(); ?>
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" name="bonus_tidak_libur" 
                               value="<?php echo e($jabatan->bonus_tidak_libur ?? 25000); ?>" min="0" required>
                    ...
                    <div class="alert alert-success border-0">
                        ...
                        <div class="mt-2">
                            ...
                            <p class="mb-0"><strong>Total bonus: 2 × Rp <?php echo e(number_format($jabatan->bonus_tidak_libur ?? 25000, 0, ',', '.')); ?> = Rp <?php echo e(number_format(2 * ($jabatan->bonus_tidak_libur ?? 25000), 0, ',', '.')); ?></strong></p>
                        </div>
                    </div>
...
</div><?php /**PATH C:\laragon\www\dashboard-fingerprint\resources\views/admin/jabatan/modals/edit-bonus.blade.php ENDPATH**/ ?>