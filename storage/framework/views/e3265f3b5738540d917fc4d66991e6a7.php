...
<div class="modal fade" id="editMinimalAbsenModal" tabindex="-1" aria-labelledby="editMinimalAbsenModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form action="<?php echo e(route('jabatan.updateMinimalAbsen', $jabatan->id)); ?>" method="POST">
                <?php echo csrf_field(); ?>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="time" class="form-control" name="minimal_absen_pagi" 
                                       value="<?php echo e($jabatan->minimal_absen_pagi ?? '07:00'); ?>" required>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="time" class="form-control" name="minimal_absen_siang" 
                                       value="<?php echo e($jabatan->minimal_absen_siang ?? '12:00'); ?>" required>
                                <small class="form-text text-muted">Karyawan yang absen sebelum jam ini akan dikenakan potongan</small>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-12">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control" name="potongan_absen_awal" 
                                       value="<?php echo e($jabatan->potongan_absen_awal ?? 10000); ?>" min="0" required>
...
</div><?php /**PATH C:\laragon\www\dashboard-fingerprint\resources\views/admin/jabatan/modals/edit-minimal-absen.blade.php ENDPATH**/ ?>